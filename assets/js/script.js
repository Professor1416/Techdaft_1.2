...
//Whatsapp Message
    document.getElementById('choose-basic-plan').addEventListener('click', function(event) {
        event.preventDefault();
        var planName = 'Basic Plan';
        var encodedMessage = encodeURIComponent('🔧 I am interested in the *' + planName + '* from TechDaft Solutions. Please provide more details and confirm the next steps. Thank you!');
        var whatsappNumber = '918530857024'; // Replace with your WhatsApp number
        var whatsappLink = 'https://wa.me/' + whatsappNumber + '?text=' + encodedMessage;
        window.location.href = whatsappLink;
    });

    document.getElementById('choose-static-plan').addEventListener('click', function(event) {
        event.preventDefault();
        var planName = 'Static Plan';
        var encodedMessage = encodeURIComponent('📦 I am interested in the *' + planName + '* from TechDaft Solutions. Please provide more details and confirm the next steps. Thank you!');
        var whatsappNumber = '918530857024'; // Replace with your WhatsApp number
        var whatsappLink = 'https://wa.me/' + whatsappNumber + '?text=' + encodedMessage;
        window.location.href = whatsappLink;
    ...
    document.getElementById('choose-dynamic-plan').addEventListener('click', function(event) {
        event.preventDefault();
        var planName = 'Dynamic Plan';
        var encodedMessage = encodeURIComponent('🚀 I am interested in the *' + planName + '* from TechDaft Solutions. Please provide more details and confirm the next steps. Thank you!');
        var whatsappNumber = '918530857024'; // Replace with your WhatsApp number
        var whatsappLink = 'https://wa.me/' + whatsappNumber + '?text=' + encodedMessage;
        window.location.href = whatsappLink;
